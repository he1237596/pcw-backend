...
const success = function (result, fields = '', code = HttpStatusCode.HTTP_OK, message = 'success') {
  if (fields) {
...
const error = function (code = HttpStatusCode.HTTP_INTERNAL_SERVER_ERROR, message = '') {
...
const throws = function (e) {
  appLogger.error(`APP返回业务应用错误，错误码：${e.code}，错误信息: ${e.message}, uuid: ${this.uuid}`)
